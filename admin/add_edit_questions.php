                        ...
                        <div class="card">
                            ...
                            <form name="form2" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card">
                                    ...
                                    Add New Questions and Answer</strong>
                                </div>
                                        <div class="card-body card-block">
                                        <div class="form-group"><label for="company" class=" form-control-label">Add Question</label><input type="text"  placeholder="Add Question" class="form-control" name="qquestion"></div>
                                        <div class="form-group"><label for="company" class=" form-control-label"> Add Opt1</label><input type="text"   class="form-control" name="qOpt1" style="padding-bottom: 45px;"></div>
                                       
                                        <div class="form-group"><label for="company" class=" form-control-label"> Add Answer</label><input type="text"   class="form-control" name="qAnswer" style="padding-bottom: 45px;"></div>
                                        <div class="form-group">
                                                    <input type="submit" name="submit3" value="Add Question" class="btn-btn-success">
...
if(isset($_POST["submit3"]))
{
    $loop=0;
           ...
           $res=mysqli_query($link,"select *from text_field where category='$exam_category'order by id asc") or die (mysqli_error($link));
    $count=mysqli_num_rows($res);
    if($count==0)
    {
        ...
        {
            $loop=$loop+1;
        mysqli_query($link,"update text_field set question_no='$loop'where id=$row[id]");
        }
    }

    $loop=$loop+1;
    mysqli_query($link,"insert into text_field values(NULL,'$loop','$_POST[qquestion]','$_POST[qOpt1]','$_POST[qAnswer]','$exam_category')") or die(mysqli_error($link));
    ?>
    <script type="text/javascript">
    alert("question added successfully");
    window.location.href=window.location.href;
